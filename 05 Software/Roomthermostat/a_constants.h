...
enum command_t { 
  ...
  cmdControl, cmdSetpointHigher, cmdSetpointAutomatic, cmdSetpointLower, cmdComeHome, cmdOverruleTodayWorkFromHome, cmdOverruleTodayWorkAtOffice, cmdOverruleTodayWeekend, cmdOverruleTodayAway, 
...
std::map<command_t, string> commandLabels = {
  ...
  { cmdSetpointAutomatic            , "Setpoint automatic"},
  ...
  { cmdOverruleTodayAutomatic       , "Switch off"},
  ...
  { cmdOverruleTomorrowAutomatic    , "Switch off"},
  ...
  { cmdOverruleMultipleAutomatic    , "Switch off"},
