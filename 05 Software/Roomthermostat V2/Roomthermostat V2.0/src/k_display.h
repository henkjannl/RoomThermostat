...
void Display::start() {
  ...
  tft->loadFont(FONT_TEMP_MEASURED, LittleFS);
...
void Display::displayHomeScreen() {
  ...
  if ( selectedScreen()==scnHome ) {
    ...
    sprite.loadFont(FONT_DATE, LittleFS);
    ...
    sprite.fillSprite(CLR_BACKGROUND);
    sprite.setTextDatum(MC_DATUM);
    sprite.loadFont(FONT_TIME, LittleFS);
    ...
    sprite.loadFont(FONT_TEMP_MEASURED, LittleFS);
    sprite.setTextDatum(MR_DATUM);
...
void Display::displayMenuScreen() {
  ...
  sprite.loadFont(FONT_MENU_HEADER, LittleFS);
  ...
  if(showSubMenuLines>0) {
    ...
    sprite.loadFont(FONT_SUBMENU, LittleFS);
