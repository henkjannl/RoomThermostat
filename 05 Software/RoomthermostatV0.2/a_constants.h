...
enum sender_t { sndKeyboard, sndBacklight, sndMenu, sndTelegram, sndController, sndDisplay, sndThermometer, sndBoiler };
...
enum command_t { cmdMenuMain, cmdSetpointHigher, cmdSetpointLower, cmdSetpointAuto, cmdGoAway, cmdUpdateStatus, 
  ...
  cmdMenuTemperature, cmdMenuSensorOffset, cmdReportBoiler, cmdReportTiming, cmdMonday, cmdTuesday, cmdWednesday, 
